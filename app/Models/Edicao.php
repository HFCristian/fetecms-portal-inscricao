...
class Edicao extends Model
{
    ...
    protected $fillable = [
        ...
        'ordem_abas',
        'turnos_config', 'turnos_gerados_em', 'turnos_gerados_por',
        'estandes_config', 'estandes_gerados_em', 'estandes_gerados_por',
        ...
        'piso_fila_avaliador',
        'cerimonial_atualizacao_segundos',
    ...
    protected function casts(): array
    {
        return [
            ...
            'ordem_abas' => 'array',
            'turnos_config' => 'array',
            'turnos_gerados_em' => 'datetime',
            'estandes_config' => 'array',
            'estandes_gerados_em' => 'datetime',
            ...
            'cerimonial_atualizacao_segundos' => 'integer',
