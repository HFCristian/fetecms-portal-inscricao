...
<head>
    ...
    {{-- Favicon (logo da XVI FETECMS). PNG é honrado pelos navegadores modernos. --}}
    <link rel="icon" type="image/png" href="/img/logo2026.png" />
    <link rel="apple-touch-icon" href="/img/logo2026.png" />
