...
export default function AdminProjetosPorCidade() {
    const [items, setItems] = useState(null);

    useEffect(() => {
        getProjetosPorLocalidade().then((d) => setItems(d.cidades)).catch(() => setItems([]));
    }, []);
    ...
    return (
        <AppShell>
            ...
            <p className="text-sm text-on-surface-variant mb-6">
                Inclui rascunhos e submetidos. Cidades sem projeto não aparecem; expanda uma cidade para ver as escolas.
            </p>
