...
(function () {
  ...
  function authShellHtml(active) {
    ...
    return [
      ...
      '<a class="' + (active === 'projetos' ? on : off) + '" href="cadastro4.html"><span class="material-symbols-outlined" style="font-variation-settings:\'FILL\' 1">folder_shared</span>Meus Projetos</a>',
      ...
      '<a class="flex flex-col items-center p-2 ' + (active === 'projetos' ? 'text-primary-container' : 'text-on-surface-variant') + '" href="cadastro4.html">',
