...
(function () {
  ...
  function initFileUploadPreview() {
    var input = document.getElementById('upload-arquivos');
    var dropzone = document.getElementById('fetec-file-dropzone');
    var preview = document.getElementById('fetec-file-preview');
    var statusEl = document.getElementById('fetec-file-status');
    var viewer = document.getElementById('fetec-file-viewer');
    var listEl = document.getElementById('fetec-file-list');
